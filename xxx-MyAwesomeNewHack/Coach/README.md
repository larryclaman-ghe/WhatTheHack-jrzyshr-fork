# What The Hack - MyAwesomeNewHack - Coach Guide

## Introduction

Welcome to the coach's guide for the MyAwesomeNewHack What The Hack. Here you will find links to specific guidance for coaches for each of the challenges.
